...
```
`LORA_WEIGHTS=models/$USER/imsg_2025-08-15_14-37/ uvicorn inference:app --host=0.0.0.0 --reload` to start the inference server, which will be available at `http://localhost:8000`.
